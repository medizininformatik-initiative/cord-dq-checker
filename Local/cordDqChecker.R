...
# cord tracer
cordTracer <- c ('A48.3','D18.10','D18.11','D18.12','D18.13','D18.18','D18.19','D45','D47.3','D57.0','D57.1','D57.2','D58.1','D76.1','D76.2','D76.3','D76.4','D82.1','D83.0','D83.1',
...
cordTracer <- paste0(cordTracer, collapse=", ")
...
if (is.null(path) | path=="")  stop("No path to data") else {
  if (grepl("fhir", path))
  {
    ...
    #source("./R/dqFhirInterface_RV_kt.R")
